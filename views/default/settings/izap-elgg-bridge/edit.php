...
<p>
  <label>
    ...
    echo elgg_view('input/text', array(
        'internalname' => 'params[izap_api_key]',
...
<p>
  <label>
    ...
    echo elgg_view('input/pulldown', array(
        'internalname' => 'params[izap_site_currency]',
        'value' => IzapBase::pluginSetting(array(
            'name' => 'izap_site_currency',
            'plugin' => GLOBAL_IZAP_ELGG_BRIDGE,

        )),    'options_values' =>trigger_plugin_hook('izap-bridge:currency_array', 'izap', null, array(
            'USD:$' => 'USD',
            'EUR:€' => 'EUR',
            'GBP:£' => 'GBP'
            )),
...
echo IzapBase::input('radio', array(
    ...
    'internalname' => 'params[izap_enable_antispam]',
));
?>
...
if (IzapBase::pluginSetting(array(
  ...
  <p>
    <label>
      ...
      echo '<br />';
      echo elgg_view('input/text', array(
          'internalname' => 'params[izap_consicutive_post_time]',
          'value' => IzapBase::pluginSetting(array(
  ...
  <p>
    <label>
      ...
      echo '<br />';
      echo elgg_view('input/text', array(
          'internalname' => 'params[izap_maximum_pings_for_spammer]',
          'value' => IzapBase::pluginSetting(array(
  ...
  <p>
    ...
    echo elgg_view('input/radio', array(
        'internalname' => 'params[izap_take_action_to_spammer]',
        'options' => array(
...
<p>
  <label>
    ...
    <?php
    echo elgg_view('input/text', array(
        'internalname' => 'params[izap_amazon_secret_key]',
        'value' => IzapBase::pluginSetting(array(
...
<p>
  <label>
    ...
    <?php
    echo elgg_view('input/text', array(
        'internalname' => 'params[izap_app_key_key]',
        'value' => IzapBase::pluginSetting(array(
            'name' => 'izap_app_key',
            'plugin' => GLOBAL_IZAP_ELGG_BRIDGE,
        )),
